...
public enum EEArmorMaterials implements ArmorMaterial {
    ...
    EEArmorMaterials(String name, int durabilityMultiplier, int[] protectionAmounts, int enchantability, SoundEvent equipSound,
    ...
    public String getName() {
        return EnhancedEnd.MOD_ID + ":" + this.name;
    }
